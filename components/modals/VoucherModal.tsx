      ...
      <div className="modal-overlay fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
        ...
        >
          ...
          <div className="p-8">
            ...
            {/* Voucher Title */}
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Voucher</h2>

            {/* Voucher Info */}
            <div className="mb-6">
              <p className="text-sm text-gray-700 mb-1">
                <span className="font-mono">#</span> Driver service day voucher
              </p>
              <div className="flex justify-between text-sm">
                <p className="text-gray-700">Contractor: {voucher.driver}</p>
                <p className="text-gray-700">Period: {voucher.issueDate}</p>
              </div>
              <p className="text-sm text-gray-700">Voucher No: VUC-R-00123</p>
            </div>
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden mb-6">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {mockVoucherDetails.map((item, index) => (
