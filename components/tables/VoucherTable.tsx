...
// Mock data based on the Voucher table design
...
export default function VoucherTable() {
  ...
  const filteredData = mockVoucherData;
  ...
  const handleViewClick = (voucher: VoucherItem) => {
  ...
  return (
    <div className="flex flex-col bg-gray-50">
      ...
      >
        ...
        <StatCard title="Total Vouchers" value="1,250" />
      ...
      <div className="flex-1 overflow-auto">
        ...
        >
          <div>
            <h2 className="text-2xl font-semibold text-gray-900">Voucher</h2>
            <p className="text-sm text-gray-600 mt-1">
              Driver Service Day Voucher
            </p>
          </div>
          <button
            onClick={handlePrint}
