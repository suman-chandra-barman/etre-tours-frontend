...
import printStyles from "@/components/styles/Print.module.css";
  ...
  return (
    <div className="flex flex-col bg-gray-50">
      <div className="flex-1 overflow-auto">
        {/* Header Section */}
        <div
          className={`flex items-center justify-between mb-6 ${printStyles.noPrint}`}
        >
        ...
        {/* Filters Section */}
        <div className={`mb-4 ${printStyles.noPrint}`}>
        ...
        {/* Table Section */}
        <div
          className={`bg-white rounded-xl border border-gray-200 overflow-hidden ${printStyles.printArea}`}
        >
          ...
          {/* Pagination */}
          <div
            className={`px-4 py-3 border-t border-gray-200 flex items-center justify-between ${printStyles.noPrint}`}
          >
