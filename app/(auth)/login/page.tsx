            ...
            <div className="relative">
              ...
              <Controller
                ...
                render={({ field }) => (
                  ...
                  >
                    <SelectTrigger className="w-full pl-12 pr-4 py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all h-auto">
                      <SelectValue
